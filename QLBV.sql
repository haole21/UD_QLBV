...
CREATE TABLE SUDUNG_DICHVU(MADV CHAR(20) NOT NULL,MABN CHAR (20)NOT NULL , TGIAN DATE)
GO 
-- TẠO BẢNG PHÒNG KHÁM_BỆNH NHÂN 
CREATE TABLE PKHAM_BENHNHAN (MAPK CHAR(20) NOT NULL , MABN CHAR (20) NOT NULL )
GO
-- XOA BẢNG 
--DROP TABLE KHOA 
--DROP TABLE NHANVIEN
