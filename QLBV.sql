...
GO 
-- TẠO BẢNG HÓA ĐƠN
CREATE TABLE HOADON (MAHD CHAR (20) NOT NULL , MADV CHAR (20) , MABN CHAR (20) NOT NULL  , THUOC CHAR (13) ,SL INT ,THANHTIEN MONEY )
GO 
-- TẠO BẢNG Dịch vụ 
...
GO 
-- TẠO BẢNG MUA_THUOC
CREATE TABLE MUA_THUOC (MATHUOC CHAR(13) NOT NULL,MABN CHAR (20)NOT NULL , SL INT NOT NULL)
GO 
