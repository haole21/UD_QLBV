...
GO 
CREATE PROC SP_THEMPKHAM_BENHNHAN (@MAPK CHAR(20), @MABN CHAR(20), @TGIAN DATE)
AS
INSERT INTO PKHAM_BENHNHAN VALUES (@MAPK, @MABN, @TGIAN)
GO
--EXEC SP_THEMPKHAM_BENHNHAN 'PK08','BN0009','9/13/2023'
GO 

CREATE PROC SP_SUAPKHAM_BENHNHAN (@MAPK CHAR(20), @MABN CHAR(20), @TGIAN DATE)
AS
