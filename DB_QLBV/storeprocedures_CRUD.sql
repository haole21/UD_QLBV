...
-- Bảng THUOC
CREATE PROC SP_THEMTHUOC (@MATHUOC CHAR(13), @TENTHUOC NVARCHAR(100), @SL TINYINT, @GIA MONEY)
AS
INSERT INTO THUOC VALUES (@MATHUOC, @TENTHUOC, @SL, @GIA)
GO

CREATE PROC SP_SUATHUOC (@MATHUOC CHAR(13), @TENTHUOC NVARCHAR(100), @SL TINYINT, @GIA MONEY)
AS
UPDATE THUOC
SET TENTHUOC = @TENTHUOC, SL = @SL, GIA = @GIA
...
CREATE PROC SP_THEMSUDUNG_DICHVU (@MADV CHAR(20), @MABN CHAR(20), @TGIAN DATE)
AS
INSERT INTO SUDUNG_DICHVU VALUES (@MADV, @MABN, @TGIAN)
GO

CREATE PROC SP_SUASUDUNG_DICHVU (@MADV CHAR(20), @MABN CHAR(20), @TGIAN DATE)
AS
...
CREATE PROC SP_THEMPKHAM_BENHNHAN (@MAPK CHAR(20), @MABN CHAR(20))
AS
INSERT INTO PKHAM_BENHNHAN VALUES (@MAPK, @MABN)
GO

CREATE PROC SP_SUAPKHAM_BENHNHAN (@MAPK CHAR(20), @MABN CHAR(20))
AS
UPDATE PKHAM_BENHNHAN
SET MABN = @MABN
WHERE MAPK = @MAPK
GO

CREATE PROC SP_XOAPKHAM_BENHNHAN (@MAPK CHAR(20), @MABN CHAR(20))
AS
DELETE FROM PKHAM_BENHNHAN
...
CREATE PROC SP_THEMPHONGKHAM (@MAPK CHAR(20), @MAK CHAR(20))
AS
INSERT INTO PHONGKHAM VALUES (@MAPK, @MAK)
GO

CREATE PROC SP_SUAPHONGKHAM (@MAPK CHAR(20), @MAK CHAR(20))
AS
UPDATE PHONGKHAM
SET MAK = @MAK
WHERE MAPK = @MAPK
...
CREATE PROC SP_XOAPHONGKHAM (@MAPK CHAR(20), @MAK CHAR(20))
AS
DELETE FROM PHONGKHAM
WHERE MAPK = @MAPK AND MAK = @MAK
GO


-- Bảng PHONGDIEUTRI

CREATE PROC SP_THEMPHONGDIEUTRI (@MAPDT CHAR(20), @LOAIPHONG NVARCHAR(30))
AS
INSERT INTO PHONGDIEUTRI VALUES (@MAPDT, @LOAIPHONG)
GO

CREATE PROC SP_SUAPHONGDIEUTRI (@MAPDT CHAR(20), @LOAIPHONG NVARCHAR(30))
AS
UPDATE PHONGDIEUTRI
...
CREATE PROC SP_THEMNHANVIEN (@MANV CHAR(20), @HONV NVARCHAR(30), @TENNV NVARCHAR(30), @SODTH VARCHAR(11), @DIACHI NVARCHAR(50), @NGAYSINH DATETIME, @PHAI NVARCHAR(10), @CHUCVU NVARCHAR(20), @NGAYLV DATETIME)
AS
INSERT INTO NHANVIEN VALUES (@MANV, @HONV, @TENNV, @SODTH, @DIACHI, @NGAYSINH, @PHAI, @CHUCVU, @NGAYLV)
GO

CREATE PROC SP_SUANHANVIEN (@MANV CHAR(20), @HONV NVARCHAR(30), @TENNV NVARCHAR(30), @SODTH VARCHAR(11), @DIACHI NVARCHAR(50), @NGAYSINH DATETIME, @PHAI NVARCHAR(10), @CHUCVU NVARCHAR(20), @NGAYLV DATETIME)
AS
UPDATE NHANVIEN
SET HONV = @HONV, TENNV = @TENNV, SODTH = @SODTH, DIACHI = @DIACHI, NGAYSINH = @NGAYSINH, PHAI = @PHAI, CHUCVU = @CHUCVU, NGAYLV = @NGAYLV
WHERE MANV = @MANV
GO
